...
int main()
{
    ...
    BF bf("10101010");
    unsigned int Nf = bf.nonlinearity();
    std::cout << "Nonlinearity on function " << bf << " is " << Nf << std::endl;
    
    std::cout << std::endl;
    std::cout << "Best affine approximation on function " << bf << " is " << std::endl;
    bf.build_best_affine();
