...
#define PanSource	"dining_philosophers_naive.pml"
...
#define _nstates2	19	/* :init: */
#define minseq2	38
#define maxseq2	55
#define _endstate2	18

#define _nstates1	22	/* phil */
#define minseq1	17
#define maxseq1	37
#define _endstate1	21

#define _nstates0	18	/* fork */
#define minseq0	0
#define maxseq0	16
...
#define Pphil	((P1 *)_this)
typedef struct P1 { /* phil */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 3; /* proctype */
	unsigned _p   : 6; /* state    */
#ifdef HAS_PRIORITY
...
#define Air1	(sizeof(P1) - Offsetof(P1, right) - 1*sizeof(uchar))

#define Pfork	((P0 *)_this)
typedef struct P0 { /* fork */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 3; /* proctype */
	unsigned _p   : 6; /* state    */
#ifdef HAS_PRIORITY
	unsigned _priority : 8; /* 0..255 */
#endif
	uchar cur_state_fork;
	uchar left_phil;
	uchar right_phil;
} P0;
#define Air0	(sizeof(P0) - Offsetof(P0, right_phil) - 1*sizeof(uchar))
